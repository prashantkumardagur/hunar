var categoryContent = [
    ...
    },
    {
        ...
        judges: '<div class="categoryJudges"><img src="guests/farhan.jpg" alt="guest"><h6>Farhan Sabbir</h6></div><div class="categoryJudges"><img src="guests/sunny.jpg" alt="guest"><h6>Sunny Hindustani</h6></div><div class="categoryJudges"><img src="guests/amaan.jpg" alt="guest"><h6>Amaan Khan</h6></div>'
    },
    {
        name: "Modelling",
        ...
        judges: '<div class="categoryJudges"><img src="guests/sameer.jpg" alt="guest"><h6>Sameer Mark</h6></div>'
    },
    {
        name: "Skit / Mime",
    ...
    },
    {
        ...
        image: ["sideimages/instrument.jpg", "sideimages/instrument-mobi.jpg"],
        paragraph: "Music without instrument is not possible. Instrument gives life to music and many are blessed to have such talents in them. <br><br> If you also possess such talent then this is the right opportunity for you to showcase your talent and get recognized by participating in one and only national level competition HUNAR 3.0, where talent meets opportunity.",
        rules: "<li>Entry fees Rs 100/Person.</li><li>There is no age category, anyone can participate.</li><li>You can perform solo, duo, trio or in a group.</li><li>If you are participating in a group then each member of the group have to register solely and then form a group. No group registration is allowed.</li><li>You have to send the freshly recorded video with no editing. There should be no retake or cuts in between the video.</li><li>The duration of the video should be between 1:00 min to 1:30 min.</li>",
        judges: '<div class="categoryJudges"><img src="guests/profile.png" alt="guest"><h6>Celeb Name</h6></div>'
    },
    {
